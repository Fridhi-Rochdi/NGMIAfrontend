...
const websiteBusinessProfiles: Record<string, {
  descriptionPlaceholder: string;
  serviceLabel: string;
  servicePlaceholder: string;
  offeringLabel: string;
  offeringNamePlaceholder: string;
  offeringDescriptionPlaceholder: string;
  priceLabel: string;
  suggestions: string[];
}> = {
  Restaurant: { descriptionPlaceholder: 'Cuisine, positionnement, ambiance, clientèle et expérience souhaitée…', serviceLabel: 'Services du restaurant', servicePlaceholder: 'Ex. Livraison, réservation, privatisation', offeringLabel: 'plats ou formules', offeringNamePlaceholder: 'Nom du plat ou de la formule', offeringDescriptionPlaceholder: 'Ingrédients, composition et particularités', priceLabel: 'Prix', suggestions: ['Réservation', 'Livraison', 'Privatisation'] },
  Boutique: { descriptionPlaceholder: 'Univers de marque, produits vendus, clientèle et différence principale…', serviceLabel: 'Services de la boutique', servicePlaceholder: 'Ex. Click & Collect, livraison', offeringLabel: 'produits', offeringNamePlaceholder: 'Nom du produit', offeringDescriptionPlaceholder: 'Caractéristiques et bénéfices client', priceLabel: 'Prix', suggestions: ['Click & Collect', 'Livraison', 'Conseil personnalisé'] },
  'Salon de coiffure': { descriptionPlaceholder: 'Style du salon, spécialités, clientèle et niveau de gamme…', serviceLabel: 'Prestations proposées', servicePlaceholder: 'Ex. Coupe, coloration, soin', offeringLabel: 'prestations', offeringNamePlaceholder: 'Nom de la prestation', offeringDescriptionPlaceholder: 'Ce qui est inclus, durée ou type de cheveux', priceLabel: 'Tarif', suggestions: ['Coupe', 'Coloration', 'Soins capillaires'] },
  'Cabinet médical': { descriptionPlaceholder: 'Spécialité, équipe, patientèle et modalités de prise en charge, sans promesse médicale…', serviceLabel: 'Soins et consultations', servicePlaceholder: 'Ex. Consultation, suivi, bilan', offeringLabel: 'consultations ou services', offeringNamePlaceholder: 'Nom de la consultation ou du service', offeringDescriptionPlaceholder: 'Public concerné et déroulement factuel', priceLabel: 'Tarif ou « Conventionné »', suggestions: ['Consultation', 'Suivi', 'Prise de rendez-vous'] },
  Avocat: { descriptionPlaceholder: 'Domaines de droit, clientèle, zone d’intervention et approche du cabinet…', serviceLabel: 'Domaines d’intervention', servicePlaceholder: 'Ex. Droit des affaires', offeringLabel: 'prestations juridiques', offeringNamePlaceholder: 'Nom de la prestation', offeringDescriptionPlaceholder: 'Périmètre et type d’accompagnement', priceLabel: 'Tarif ou « Sur devis »', suggestions: ['Droit des affaires', 'Conseil', 'Contentieux'] },
  Architecte: { descriptionPlaceholder: 'Types de projets, philosophie, zone d’intervention et expertise…', serviceLabel: 'Expertises du cabinet', servicePlaceholder: 'Ex. Conception, rénovation', offeringLabel: 'services ou projets', offeringNamePlaceholder: 'Nom du service ou du projet', offeringDescriptionPlaceholder: 'Périmètre, style et valeur apportée', priceLabel: 'Budget ou « Sur devis »', suggestions: ['Conception', 'Rénovation', 'Suivi de chantier'] },
  'Agence immobilière': { descriptionPlaceholder: 'Zone couverte, types de biens, services et clientèle ciblée…', serviceLabel: 'Services immobiliers', servicePlaceholder: 'Ex. Vente, location, estimation', offeringLabel: 'biens ou services', offeringNamePlaceholder: 'Nom du bien ou du service', offeringDescriptionPlaceholder: 'Localisation, surface et points forts', priceLabel: 'Prix ou « Sur demande »', suggestions: ['Vente', 'Location', 'Estimation'] },
  'Auto-école': { descriptionPlaceholder: 'Permis proposés, méthode, zone, véhicules et accompagnement…', serviceLabel: 'Formations proposées', servicePlaceholder: 'Ex. Permis B, conduite accompagnée', offeringLabel: 'formules', offeringNamePlaceholder: 'Nom de la formule', offeringDescriptionPlaceholder: 'Heures incluses, supports et conditions', priceLabel: 'Tarif', suggestions: ['Permis B', 'Code de la route', 'Conduite accompagnée'] },
  'Fitness / Salle de sport': { descriptionPlaceholder: 'Concept, équipements, cours, coaching et profils des adhérents…', serviceLabel: 'Activités et accompagnements', servicePlaceholder: 'Ex. Coaching, yoga, musculation', offeringLabel: 'abonnements ou cours', offeringNamePlaceholder: 'Nom de l’abonnement ou du cours', offeringDescriptionPlaceholder: 'Accès, fréquence et avantages inclus', priceLabel: 'Tarif', suggestions: ['Coaching', 'Cours collectifs', 'Musculation'] },
  Autre: { descriptionPlaceholder: 'Décrivez votre métier, votre offre, votre clientèle et ce qui vous différencie…', serviceLabel: 'Services proposés', servicePlaceholder: 'Ajouter un service…', offeringLabel: 'offres', offeringNamePlaceholder: 'Nom de l’offre', offeringDescriptionPlaceholder: 'Description utile au client', priceLabel: 'Prix ou « Sur devis »', suggestions: [] },
};
  ...
  return (
    <div className="min-h-full bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {view === 'editor' && siteId && (
          <Editor id={siteId} onBack={() => router.push('/websites')} />
        )}
      </div>
    </div>
  );
...
function Wizard({ onCancel, onGenerated }: { onCancel: () => void; onGenerated: (id: string) => void }) {
  ...
  const websiteProfile = websiteBusinessProfiles[businessType] || websiteBusinessProfiles.Autre;

  const handleBusinessTypeChange = (value: string) => {
    setBusinessType(value);
    if (services.length === 0) {
      setServices([...(websiteBusinessProfiles[value]?.suggestions || [])]);
    }
  };
  ...
  return (
    <>
      ...
      <div className="flex justify-center mb-8 text-sm text-gray-600">
        {step === 1 && 'Informations'}
        {step === 2 && `${websiteProfile.offeringLabel.charAt(0).toUpperCase()}${websiteProfile.offeringLabel.slice(1)} & Galerie`}
        {step === 3 && 'Design'}
      </div>
      ...
      {step === 1 && (
        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          ...
          <Field label="Type d'activité *">
            <select value={businessType} onChange={(e) => handleBusinessTypeChange(e.target.value)} className={inputCls}>
              <option value="">Sélectionnez…</option>
              {businessTypes.map((t) => <option key={t} value={t}>{t}</option>)}
            </select>
          </Field>
          <Field label="Description *">
            <textarea value={description} onChange={(e) => setDescription(e.target.value)} rows={3} className={inputCls} placeholder={websiteProfile.descriptionPlaceholder} />
          </Field>
          <Field label={websiteProfile.serviceLabel}>
            <div className="flex gap-2 mb-2">
              <input value={newService} onChange={(e) => setNewService(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && (e.preventDefault(), addService())} className={`${inputCls} flex-1`} placeholder={websiteProfile.servicePlaceholder} />
      ...
      {step === 2 && (
        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          <div className="flex items-center gap-2 text-sm text-blue-700 bg-blue-50 rounded-lg px-3 py-2">
            Ajoutez vos {websiteProfile.offeringLabel}. Sans photo, l’IA peut générer un visuel adapté. Cette étape reste facultative.
          </div>
          ...
          {products.length === 0 && (
            <p className="text-sm text-gray-500">Aucune offre ajoutée — le site sera généré à partir de vos services.</p>
          )}
              ...
              <div key={i} className="border border-gray-200 rounded-xl p-4 flex gap-4 items-start">
                ...
                <div className="flex-1 grid md:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input value={p.name} onChange={(e) => updateProduct(i, { name: e.target.value })} className={inputCls} placeholder={websiteProfile.offeringNamePlaceholder} />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1">{websiteProfile.priceLabel} *</label>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input value={p.description || ''} onChange={(e) => updateProduct(i, { description: e.target.value })} className={inputCls} placeholder={websiteProfile.offeringDescriptionPlaceholder} />
                  </div>
